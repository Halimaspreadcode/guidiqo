...
export default function Footer() {
  return (
    <footer className="py-12 sm:py-16 px-3 sm:px-4 md:px-6 border-t border-gray-200 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="sm:col-span-2 md:col-span-1">
            <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-black">Guidiqo</h3>
        ...
        <motion.div 
          className="pt-6 sm:pt-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 text-xs sm:text-sm text-gray-600"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <div className="flex gap-4 sm:gap-6">
            <a href="#" className="hover:text-black transition-colors duration-200">Confidentialité</a>
            <a href="#" className="hover:text-black transition-colors duration-200">Conditions</a>
            <a href="#" className="hover:text-black transition-colors duration-200">Cookies</a>
          </div>
        </motion.div>
      </div>
    </footer>
